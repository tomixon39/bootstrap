	...
	<!-- Title -->
        ...
        <section id="content">
            ...
            <div class="row padding-1">
                <div class="container">
                    <?php $query = new WP_Query( array('p' => 34 ) ); ?>
                    ...
                    <div class="col-lg-4">
                        ...
                        <p class="text-center minip">
                           <?php the_content(); ?>
                        </p>
                        <br>
                        <a href="http://www.hbklima.viewmake.pl/klimatyzacja-pojazdowa/" class="link-mini">Więcej <span class="glyphicon glyphicon-menu-right"></span></a>
                       
                    </div>
                    <?php endwhile;?>
                    <?php endif; ?>

                    <?php $query = new WP_Query( array('p' => 31 ) ); ?>
                    <?php if ( $query->have_posts() ) : while ( $query->have_posts() ) : $query->the_post(); ?>      
                    <div class="col-lg-4">
                        ...
                        <br>
                        <a href="http://www.hbklima.viewmake.pl/oferta/" class="link-mini">Więcej <span class="glyphicon glyphicon-menu-right"></span></a>
                       
                    </div>
                    <?php endwhile;?>
                    <?php endif; ?>

                    <?php $query = new WP_Query( array('p' => 25 ) ); ?>
                    <?php if ( $query->have_posts() ) : while ( $query->have_posts() ) : $query->the_post(); ?>      
                    <div class="col-lg-4">
