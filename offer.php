            ...
            <div class="row padding-1">
                <div class="container">
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-8">
                            <h3 class="naglowek"><span class="glyphicon glyphicon-folder-open green"></span> <?php the_title(); ?></h3>
                          ...
                          <div class="col-lg-6">
                        <?php $query = new WP_Query( array('p' => 65 ) ); ?>
                        <?php if ( $query->have_posts() ) : while ( $query->have_posts() ) : $query->the_post(); ?>
                        <h3 class="naglowek"><span class="glyphicon glyphicon-cog green"></span> <?php the_title(); ?></h3>
                    ...
                    <div class="col-lg-6">
                        <?php $query = new WP_Query( array('p' => 67 ) ); ?>
                        <?php if ( $query->have_posts() ) : while ( $query->have_posts() ) : $query->the_post(); ?>
                        <h3 class="naglowek"><span class="glyphicon glyphicon-home green"></span> <?php the_title(); ?></h3>
                    ...
                    <div class="col-lg-6">
                        <?php $query = new WP_Query( array('p' => 69 ) ); ?>
                        <?php if ( $query->have_posts() ) : while ( $query->have_posts() ) : $query->the_post(); ?>
                        <h3 class="naglowek"><span class="glyphicon glyphicon-time green"></span> <?php the_title(); ?></h3>
                    ...
                    <div class="col-lg-6">
                        <?php $query = new WP_Query( array('p' => 71 ) ); ?>
                        <?php if ( $query->have_posts() ) : while ( $query->have_posts() ) : $query->the_post(); ?>
                        <h3 class="naglowek"><span class="glyphicon glyphicon-leaf green"></span> <?php the_title(); ?></h3>
